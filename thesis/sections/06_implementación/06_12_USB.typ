...
lo que sencillamente se añaden a la descripción del dispositivo las interfaces usadas.
...
milisegundo datos al dispositivo. De esta manera, Sparklet se ahorra la complejidad de tener un reloj interno
...
eventos, se almacena en el estado y sencillamente se multiplica por el volumen correspondiente.
